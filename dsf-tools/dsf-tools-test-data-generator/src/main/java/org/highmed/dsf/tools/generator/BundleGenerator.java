...
public class BundleGenerator {
    ...
    private void createDockerTestDic1Bundle(Map<String, CertificateFiles> clientCertificateFilesByCommonName) {
    ...
    private void setThumbprint(Organization organization, CertificateFiles files) {
        organization
    ...
    private void createDockerTestDic2Bundle(Map<String, CertificateFiles> clientCertificateFilesByCommonName) {
    ...
    private void createDockerTestZarsBundle(Map<String, CertificateFiles> clientCertificateFilesByCommonName) {
    ...
    public void copyDockerTestBundles() {
        Path dic1BundleFile = Paths.get("../../dsf-docker-test-setup/dic-1/fhir/app/conf/bundle.xml");
        logger.info("Copying fhir bundle to {}", dic1BundleFile);
        writeBundle(dic1BundleFile, dic1Bundle);

        Path dic2BundleFile = Paths.get("../../dsf-docker-test-setup/dic-2/fhir/app/conf/bundle.xml");
        logger.info("Copying fhir bundle to {}", dic2BundleFile);
        writeBundle(dic2BundleFile, dic2Bundle);

        Path dic3BundleFile = Paths.get("../../dsf-docker-test-setup/zars/fhir/app/conf/bundle.xml");
